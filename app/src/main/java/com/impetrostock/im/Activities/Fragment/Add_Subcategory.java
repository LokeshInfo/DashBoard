...
public class Add_Subcategory extends Fragment
{
    @BindView(R.id.SpParentCat)
    Spinner SpinnerParentCat;
    ...
    String ParentCat[] = {"Womens","Mens"};

    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        activity = (Activity)context;
        add_subcategory = this;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        txToolbar.setText("New Subcategory");
        toolbar.setNavigationIcon(R.drawable.ic_arrow_back_black_24dp);

        ArrayAdapter<String> adsupplier = Utilview.setupAdapter(getActivity(),SpinnerParentCat,ParentCat,"Select Category");
        SpinnerParentCat.setAdapter(adsupplier);
