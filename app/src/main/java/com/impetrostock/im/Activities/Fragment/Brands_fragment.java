...
public class Brands_fragment extends Fragment
{
    ...
    Brands_fragment brands_fragment;
    ...
    {
        Add_Brands adBrand = new Add_Brands();
        getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_layout,adBrand).addToBackStack("Add_Brands").commit();
    }
