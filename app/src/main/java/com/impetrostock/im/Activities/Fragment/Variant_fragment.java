...
public class Variant_fragment extends Fragment
{
    ...
    {
        Add_Variant adVar = new Add_Variant();
        getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_layout,adVar).addToBackStack("Add_Var").commit();
    }
