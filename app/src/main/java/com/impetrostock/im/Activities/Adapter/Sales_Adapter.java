...
{
    private List<Sales_Data> dataList;
    Activity mActivity;
    private OnItemTouchListener onItemTouchListener;

    public Sales_Adapter(Activity mActivity, List<Sales_Data> dataList,OnItemTouchListener onItemTouchListener)
    {
    ...
    public Sales_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_sales_list,parent,false);
        return new Sales_Adapter.ViewHolder(v);
    }


    @Override
    public void onBindViewHolder(Sales_Adapter.ViewHolder holder, int position) {
        Sales_Data sob = dataList.get(position);
        ...
        if (holder!=null)
        {
            ...
            holder.PaidAmt.setText("Paid Amount : "+sob.getPaidAmt());
            holder.DueAmt.setText("Due Amount : "+sob.getDueAmt());
        }
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public ViewHolder(View itemview)
        {
            ...
            PaidAmt = itemview.findViewById(R.id.tx_paidamt);
            DueAmt = itemview.findViewById(R.id.tx_dueamt);
