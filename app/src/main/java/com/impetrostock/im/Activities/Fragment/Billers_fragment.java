...
import com.impetrostock.im.Activities.Adapter.Billers_Adapter;
...
public class Billers_fragment extends Fragment
{
    ...
    Billers_Adapter adapter;
    OnItemTouchListener itemTouchListener;
    Billers_fragment billers_fragment;

    Fragment fragment;

    List<Billers_Data> dataList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new Billers_Adapter(activity,dataList,itemTouchListener);
    ...
    {
        Add_Biller adbiller = new Add_Biller();
        getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_layout,adbiller).addToBackStack("Add_Biller").commit();
    }

    private void prdata()
    {
        dataList.add(new Billers_Data("Anil","Impetrosys","9977699665","anil.impetrosys@outlook.com",
