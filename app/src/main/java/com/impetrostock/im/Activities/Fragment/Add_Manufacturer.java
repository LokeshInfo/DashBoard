...
public class Add_Manufacturer extends Fragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_add_manufacturer,container,false);
        ...
        txToolbar.setText("New Manufacturer");
